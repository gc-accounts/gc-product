export const redirectsList = [
      ...
      {
        "source": "/cyber-security/:path*", 
        "destination": "/", 
        "permanent": true
      },
      {
        "source": "/e-learning/:path*", 
        "destination": "/", 
        "permanent": true
      },
      {
        "source": "/agile-and-scrum-training-instructor-led/:path*", 
        "destination": "/", 
        "permanent": true
      },
      {
      ...
      {
        "source": "/lean-six-sigma-green-and-black-belt-training-combo/:path*", 
        "destination": "/", 
        "permanent": true
      },
      {
        "source": "/six-sigma-green-belt-training-instructor-led/:path*", 
        "destination": "/", 
        "permanent": true
      },
      {
        "source": "/fullstack-development-foundation-program/:path*", 
        "destination": "/", 
        "permanent": true
      },
      {
      ...
      {
        "source": "/lean-six-sigma-black-belt-training-instructor-led/:path*", 
        "destination": "/", 
        "permanent": true
      },
      {
      ...
      {
        "source": "/vineet-choudhary/:path*", 
        "destination": "/", 
        "permanent": true
      },
      {
        "source": "/capm-training-instructor-led/:path*", 
        "destination": "/", 
        "permanent": true
      },
      {
        "source": "/parveen-kumar/:path*", 
        "destination": "/", 
        "permanent": true
      },
      {
        "source": "/pmp-training-instructor-led/:path*", 
        "destination": "/", 
        "permanent": true
      },
      {
        "source": "/fundamentals-of-php-training-course/:path*", 
        "destination": "/", 
        "permanent": true
      },
      {
      ...
      {
        "source": "/six-sigma-yellow-belt-certification-training-course/:path*", 
        "destination": "/", 
        "permanent": true
      },
      {
        "source": "/devops-ci-cd-with-jenkins-pipelines-maven-gradle-training-course/:path*", 
        "destination": "/", 
        "permanent": true
      },
      {
        "source": "/adam-keddy/:path*", 
        "destination": "/", 
        "permanent": true
      },
      {
        "source": "/professional-graphic-designer-training-course/:path*", 
        "destination": "/", 
        "permanent": true
      },
      {
      ...
      {
        "source": "/ahmad-sulaiman/:path*", 
        "destination": "/", 
        "permanent": true
      },
      {
        "source": "/lean-six-sigma-green-belt-training-instructor-led/:path*", 
        "destination": "/", 
        "permanent": true
      },
      {
      ...
      {
        "source": "/deep-learning-for-nlp-using-tensorflow/:path*", 
        "destination": "/", 
        "permanent": true
      },
      {
        "source": "/divanshu-paliwal/:path*", 
        "destination": "/", 
        "permanent": true
      },
      {
        "source": "/prince2-practitioner-training-instructor-led/:path*", 
        "destination": "/", 
        "permanent": true
      },
      {
        "source": "/pmi-acp-certification-training/:path*", 
        "destination": "/", 
        "permanent": true
      },
      {
        "source": "/prince2-foundation-and-practitioner-training-combo/:path*", 
        "destination": "/", 
        "permanent": true
      },
      {
        "source": "/victoria-clarke/:path*", 
        "destination": "/", 
        "permanent": true
      },
      {
        "source": "/adam-sales/:path*", 
        "destination": "/", 
        "permanent": true
      },
      {
        "source": "/aishwarya-srivastava/:path*", 
        "destination": "/", 
        "permanent": true
      },
      {
        "source": "/adolfo-o-calderon-c/:path*", 
        "destination": "/", 
        "permanent": true
      },
      {
        "source": "/kevin-hoppe/:path*", 
        "destination": "/", 
        "permanent": true
      },
      {
        "source": "/csm-training-instructor-led/:path*", 
        "destination": "/", 
        "permanent": true
      },
      {
        "source": "/build-modern-web-apps-with-mean-training-course/:path*", 
        "destination": "/", 
        "permanent": true
      },
      {
      ...
      {
        "source": "/paritala-bala-gopi-raju/:path*", 
        "destination": "/", 
        "permanent": true
      },
      {
        "source": "/apurva-shah/:path*", 
        "destination": "/", 
        "permanent": true
      },
      {
        "source": "/hiren-joshi/:path*", 
        "destination": "/", 
        "permanent": true
      },
      {
        "source": "/machine-learning-for-app-training-course/:path*", 
        "destination": "/", 
        "permanent": true
      },
      {
        "source": "/full-stack-development-masters-program/:path*", 
        "destination": "/", 
        "permanent": true
      },
      {
        "source": "/david-ovitt-jr/:path*", 
        "destination": "/", 
        "permanent": true
      },
      {
        "source": "/kathryn-battle/:path*", 
        "destination": "/", 
        "permanent": true
      },
      {
        "source": "/introduction-to-data-science/:path*", 
        "destination": "/", 
        "permanent": true
      },
      {
        "source": "/programming/:path*", 
        "destination": "/", 
        "permanent": true
      },
      {
        "source": "/ruby-fundamentals-online-self-learning/:path*", 
        "destination": "/", 
        "permanent": true
      },
      {
        "source": "/xml-training-instructor-led/:path*", 
        "destination": "/", 
        "permanent": true
      },
      {
        "source": "/project-management/:path*", 
        "destination": "/", 
        "permanent": true
      },
      {
        "source": "/intro-to-the-nem-blockchain-for-developers-training-course/:path*", 
        "destination": "/", 
        "permanent": true
      },
      {
        "source": "/big-data-hadoop-developer-training-instructor-led/:path*", 
        "destination": "/", 
        "permanent": true
      },
      {
        "source": "/microsoft-70-462-administering-sql-server-2012-databases-training-course/:path*", 
        "destination": "/", 
        "permanent": true
      },
      {
        "source": "/python-object-oriented-programming-fundamentals-training-course/:path*", 
        "destination": "/", 
        "permanent": true
      },
      {
        "source": "/elearning-bundle/:path*", 
        "destination": "/", 
        "permanent": true
      },
      {
        "source": "/pmpGreyCampus/:path*", 
        "destination": "/", 
        "permanent": true
      },
      {
        "source": "/sql-training-instructor-led/:path*", 
        "destination": "/", 
        "permanent": true
      },
      {
        "source": "/build-a-website-from-scratch-using-html-css-javascript/:path*", 
        "destination": "/", 
        "permanent": true
      },
      {
        "source": "/prince2-foundation-training-instructor-led/:path*", 
        "destination": "/", 
        "permanent": true
      },
      {
        "source": "/sap-netweaver-process-integration-training-instructor-led/:path*", 
        "destination": "/", 
        "permanent": true
      },
      {
        "source": "/sap-business-planning-and-consolidation-administration-and-planning-configuration-training-instructor-led/:path*", 
        "destination": "/", 
        "permanent": true
      },
      {
        "source": "/itil-foundation-training-instructor-led/:path*", 
        "destination": "/", 
        "permanent": true
      },
      {
        "source": "/mohamed-elmasry/:path*", 
        "destination": "/", 
        "permanent": true
      },
      {
        "source": "/sap-workflow-management-training-instructor-led/:path*", 
        "destination": "/", 
        "permanent": true
      },
      {
        "source": "/codelabs/:path*", 
        "destination": "/", 
        "permanent": true
      },
      {
        "source": "/rohit-sharma/:path*", 
        "destination": "/", 
        "permanent": true
      },
      {
        "source": "/cloud-computing-certifications/:path*", 
        "destination": "/", 
        "permanent": true
      },
      {
        "source": "/leadership-skills-vs-management-training-course/:path*", 
        "destination": "/", 
        "permanent": true
      },
      {
        "source": "/sap-training/:path*", 
        "destination": "/", 
        "permanent": true
      },
      {
        "source": "/sap-plant-maintenance-training-instructor-led/:path*", 
        "destination": "/", 
        "permanent": true
      },
      {
