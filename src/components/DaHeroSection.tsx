          ...
          <div className="space-y-8">
            ...
            <div className="pt-6 flex flex-col sm:flex-row gap-4">
              ...
              <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                ...
                {/* Removed overflow-hidden to fix reCAPTCHA interaction issues */}
                <DialogContent className="max-w-[90vw] sm:max-w-112 md:max-w-128 w-full rounded-2xl p-0">
                  {/* Added rounded-t-2xl to header for visual consistency */}
                  ...
                  <div className="max-h-[85vh] overflow-y-auto px-6 pb-6 pt-2">
                    <DaForm isModal={true} onClose={() => setIsDialogOpen(false)} />
                  </div>
                </DialogContent>
              </Dialog>
            </div>
