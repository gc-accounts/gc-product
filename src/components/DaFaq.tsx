    ...
    const faqs = {
      curriculum: [
        ...
        },
        {
          ...
          answer: "We provide 100% Placement assistance to all students who complete the Bootcamp, meeting the expected performance standards and continue to offer this assistance up until two years following the bootcamp's start date."
        },
        {
        ...
        {
          question: 'Is there a refund policy for this Data Analyst Bootcamp?',
