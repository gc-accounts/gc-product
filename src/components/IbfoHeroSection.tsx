          ...
          <div className="space-y-6 lg:space-y-8">
            <div className="space-y-6">
              ...
              <p className="text-base sm:text-lg md:text-xl text-medium-gray leading-relaxed">
                Job-aligned curriculum designed to build real-world finance skills. Launch a career in global banking and financial operations.
              </p>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <span className="text-sm sm:text-base text-dark-gray leading-relaxed">
                    Industry-relevant finance and banking projects
                  </span>
                </div>
                <div className="flex items-start space-x-3">
                  <BookOpen className="w-5 h-5 sm:w-6 sm:h-6 text-primary-green shrink-0 mt-0.5" />
                  <span className="text-sm sm:text-base text-dark-gray leading-relaxed">
                    Learn from top finance professionals
                  </span>
                </div>
                <div className="flex items-start space-x-3">
