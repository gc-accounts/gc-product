...
const HomeJobDrives = ({ sectionClass }: CardsProps) => {
  // Merge both arrays, showing 4 from each
  const jobsData = [...AimlJobsDrives.slice(0, 4), ...DsJobsDrives.slice(0, 4)];
      ...
      <div className="container max-w-7xl mx-auto">
        <div className="text-center mb-8 lg:mb-10 max-w-8xl">
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-dark-gray mb-2 lg:mb-3">
            Job Drives That Lead to Real Careers
          </h2>
          <p className="text-sm md:text-base text-medium-gray mx-auto leading-relaxed">
            GreyCampus helps your students turn their learning into jobs.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          <div className="lg:col-span-4">
            <p className='mb-2'>We organize job drives to connect students directly with top companies. These drives are exclusive to learners who complete the ICT Programs</p>
            <p className='mb-2'>Students also get access to the GreyCampus Placement Portal, where they can explore new job openings, apply directly, and take part in both online and campus hiring events.</p>
            <p>With over 400+ hiring partners and 50,000+ students trained, our job drives have helped thousands of graduates start their careers in Data Science, AI, and Analytics.</p>
          </div>
