    ...
    <>
      <div className="flex flex-col min-h-screen">
        ...
        <main className='mt-16'>
          <DsHeroSection sectionClass="bg-gradient-hero px-[20px] py-[50px] md:px-[30px] md:py-[70px]" />
          ...
          <DSBFeeModule title='Invest in Your Future at Affordable Prices' subText='The most cost-effective bootcamp without compromising quality' sectionClass="bg-white px-[20px] py-[50px] md:px-[30px] md:py-[70px]" />
